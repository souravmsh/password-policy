...
<header class="header mt-3">
    ...
    <div class="pull-right" style="margin-top: 0px">
        <a href="{{  route('password-policy.checklist.create')  }}" class="btn btn-sm btn-primary" data-modal="ajaxifyModal">
    ...
    {{Form::model($_REQUEST, ['method' => 'get'])}}
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="{{route('password-policy.checklist')}}" class="btn btn-sm btn-danger">Clear</a>
            </div>
        </div>
    {{Form::close()}}
</section>
                ...
                @if($result->count())
                    @foreach($result as $item)
                        <tr>
                            ...
                            <td style="width: 10%">
                                <a class="btn btn-primary btn-sm" data-modal="ajaxifyModal" href="{{ route('password-policy.checklist.edit', $item->id) }}">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                @endif

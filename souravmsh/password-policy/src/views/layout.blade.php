    ...
    <div class="container my-3">
        <div class="row">
            ...
            <div class="flex-shrink-0 p-3 bg-white" style="width: 280px;">
                <a href="{{ route('password-policy.expiry') }}" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
                  <svg class="bi me-2" width="30" height="24"><use xlink:href="#bootstrap"></use></svg>
                  <h1 class="fs-4 fw-bold">Password Policy</h1>
                </a>
                <ul class="list-unstyled ps-0">
                  <li class="mb-1">
                    <button class="btn btn-toggle align-items-center rounded" data-bs-toggle="collapse" data-bs-target="#password-policy-collapse" aria-expanded="false">
                      Menu
                    </button>
                    <div class="collapse show" id="password-policy-collapse" style="">
                      <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li>
                            <a href="{{  route('password-policy.expiry')  }}" class="link-dark rounded"> User Expiration</a>
                        </li>
                        <li> 
                            <a href="{{  route('password-policy.pretend.show')  }}" data-modal="ajaxifyModal" class="link-dark rounded"> Pretend Login</a>
                        </li>
                        <li>
                            <a href="{{  route('password-policy.rules')  }}" class="link-dark rounded"> Password Rules</a>
                        </li> 
                        <li>
                            <a href="{{  route('password-policy.checklist')  }}" class="link-dark rounded"> Password Checklist</a>
                        </li> 
                      </ul>
                    </div>
                  </li> 

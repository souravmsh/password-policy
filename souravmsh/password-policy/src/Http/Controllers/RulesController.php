...
{    
    ...
    public function __construct(Request $request)
    {
        ...
        $this->viewPath = 'password-policy::rules.';
        $this->page     = __('Rules');
        $this->redirect = route('password-policy.rules');
    }
    ...
    public function create()
    {
        $data = (object)[
            'page'   => $this->page,
            'method' => 'Update',
            'action' => route('password-policy.rules.update'),
            'item'   => [],
    ...
    public function update(Request $request)
    {
        ...
        try
        {
            $exists = $this->passwordPolicyRules->pluck('attribute')->toArray();
    ...
    {
        return $this->passwordPolicyRules
            ->where(function($q){

...
Route::prefix('password-policy')
->name('password-policy.')
->namespace('Souravmsh\PasswordPolicy\Http\Controllers')
->middleware(['web', 'auth'])
->group(function() {  
    Route::get('/', 'PasswordPolicyController@index')->name('expiry');
    Route::get('/expiry/create', 'PasswordPolicyController@create')->name('expiry.create');
    Route::post('/expiry', 'PasswordPolicyController@store')->name('expiry.save');
    Route::get('/expiry/{id}', 'PasswordPolicyController@edit')->name('expiry.edit');
    Route::put('/expiry/{id}', 'PasswordPolicyController@update')->name('expiry.update');
